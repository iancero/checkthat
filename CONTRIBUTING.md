...
This outlines how to propose a change to checkthat. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("iancero/checkthat", fork = TRUE)`.
...
Please note that the checkthat project is released with a [Contributor
Code of
Conduct](https://iancero.github.io/checkthat/CODE_OF_CONDUCT.md). By
