...
#' @return \code{TRUE} if \code{x} is integer-like, otherwise \code{FALSE}.
#'
...
#'
#' @param x Numeric value to check.
#' @return \code{TRUE} if \code{x} is a proportion, otherwise \code{FALSE}.
#'
...
#' @return \code{TRUE} if \code{x} is a valid proportion, otherwise it throws
#'          an error.
#'
#' @seealso \code{\link{is_proportion}}, \code{\link{is_count}},
...
#' validate_proportion(1.2)   # Error: Not a valid proportion
#'
...
#' @return \code{TRUE} if \code{x} is a count, otherwise \code{FALSE}.
#'
...
#' @param include_zero Logical, whether to include zero as a valid count.
#' @return \code{TRUE} if \code{x} is a valid count, otherwise it throws an
#'          error.
#'
...
#' validate_count(0, include_zero = FALSE) # Error: Not a valid count value.
#' validate_count(-1)  # Error: Not a valid count value.
#'
...
#' @return \code{TRUE} if the logical vector is valid, otherwise it throws an
#'          error.
#'
#' @seealso \code{\link{is_proportion}}, \code{\link{is_count}},
#'          \code{\link{validate_proportion}}, \code{\link{validate_count}}
...
#' validate_logical_vec(c()) # Error: logical_vec must have length of at least 1
#' validate_logical_vec(c(NA, NA)) # Warning: All values of logical_vec are NA
#'
